...
using [timeslot](https://github.com/NordicPlayground/nRF51-multi-role-conn-observer-advertiser/tree/master)

###### advertiser - advertisement(timeslot) & scan reponse

- main.c
  - ble_setup() -> nrf_advertiser.c
  - SWIO_IRQHandler - received scan req
- btle_hci/nrf_advertiser.c
- btle_hci/ts.controller.c

###### observer - advertisement(only ) & scan request

- main.c - active scanner (request)
- btle_hci/nrf_scan.c
  - btle_scan_ev_get (received the advertisement package???)
  - btle_scan_param_set
  - btle_scan_enable_get
- btle_hci/ll_scan.c
  - ll_scan_start
...
- code
  ...
  [characteristic](https://github.com/NordicPlayground/nrf5-ble-tutorial-characteristic/tree/master)

- articles

  [ble-advertising-primer](https://www.argenox.com/library/bluetooth-low-energy/ble-advertising-primer/)

  [ble_scan_adv_basic](http://dev.ti.com/tirex/content/simplelink_academy_cc2640r2sdk_1_12_01_16/modules/ble_scan_adv_basic/ble_scan_adv_basic.html)
